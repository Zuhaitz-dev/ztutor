...
/*
** Object definitions copied directly from the official Neovim Engine Source.
** Core Subsystem: Type Definitions & Architectural State Layouts
** Source Reference: https://github.com/neovim/neovim/blob/master/src/nvim/types_defs.h
*/
...
#define TRISTATE_TO_BOOL(val, default) ((val) == kTrue ? true : ((val) == kFalse ? false : (default)))
